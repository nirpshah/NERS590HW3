...
// user enters the XML file name and pugixml will attempt to load
	...
	N_start   			= input_histories.attribute("start").as_int();
	number_of_histories 	= input_histories.attribute("end").as_int();
	max_time            = input_simulation.child("timecut").attribute("maxtime").as_double();
